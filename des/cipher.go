...
func (c *desCipher) Encrypt(dst, src []byte) error {
	if len(src) < BlockSize {
		return errors.New("crypto/des-input not full block")
	}
	if len(dst) < BlockSize {
		return errors.New("crypto/des-output not full block")
	}
	if subtle.InexactOverlap(dst[:BlockSize], src[:BlockSize]) {
		return errors.New("crypto/des-invalid buffer overlap")
	}
	encryptBlock(c.subkeys[:], dst, src)
	return nil
}

func (c *desCipher) Decrypt(dst, src []byte) error {
	if len(src) < BlockSize {
		return errors.New("crypto/des-input not full block")
	}
	if len(dst) < BlockSize {
...
func (c *tripleDESCipher) Encrypt(dst, src []byte) error {
	if len(src) < BlockSize {
		return errors.New("crypto/des-input not full block")
	}
	if len(dst) < BlockSize {
...
func (c *tripleDESCipher) Decrypt(dst, src []byte) error {
	if len(src) < BlockSize {
		return errors.New("crypto/des-input not full block")
	}
	if len(dst) < BlockSize {
