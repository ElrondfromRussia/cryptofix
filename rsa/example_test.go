...
func ExampleDecryptPKCS1v15SessionKey() {
	...
	if err := DecryptPKCS1v15SessionKey(rng, rsaPrivateKey, rsaCiphertext, key); err != nil {
		...
		// public key.)
		_, _ = fmt.Fprintf(os.Stderr, "Error from RSA decryption: %s\n", err)
		return
	}
	...
	if err != nil {
		...
		_, _ = fmt.Fprintf(os.Stderr, "Error decrypting: %s\n", err)
		return
	}
...
func ExampleSignPKCS1v15() {
	...
	signature, err := SignPKCS1v15(rng, rsaPrivateKey, cryptofix.SHA256, hashed[:])
	if err != nil {
...
func ExampleVerifyPKCS1v15() {
	...
	err := VerifyPKCS1v15(&rsaPrivateKey.PublicKey, cryptofix.SHA256, hashed[:], signature)
	if err != nil {
...
func ExampleEncryptOAEP() {
	...
	if err != nil {
		_, _ = fmt.Fprintf(os.Stderr, "Error from encryption: %s\n", err)
		return
	}

	// Since encryption is a randomized function, ciphertext will be
	// different each time.
	_, _ = fmt.Printf("Ciphertext: %x\n", ciphertext)
}
