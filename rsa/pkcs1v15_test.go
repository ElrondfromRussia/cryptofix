...
func TestEncryptPKCS1v15(t *testing.T) {
	...
	tryEncryptDecrypt := func(in []byte, blind bool) bool {
		...
		plaintext, err := DecryptPKCS1v15(randP, rsaPrivateKey, ciphertext)
		if err != nil {
	...
	_ = quick.Check(tryEncryptDecrypt, config)
}
...
func TestSignPKCS1v15(t *testing.T) {
	for i, test := range signPKCS1v15Tests {
		...
		s, err := SignPKCS1v15(nil, rsaPrivateKey, cryptofix.SHA1, digest)
		if err != nil {
			t.Errorf("#%d %s", i, err)
		}
...
func TestVerifyPKCS1v15(t *testing.T) {
	for i, test := range signPKCS1v15Tests {
		...
		err := VerifyPKCS1v15(&rsaPrivateKey.PublicKey, cryptofix.SHA1, digest, sig)
		if err != nil {
			t.Errorf("#%d %s", i, err)
		}
	}
...
func TestUnpaddedSignature(t *testing.T) {
	...
	sig, err := SignPKCS1v15(nil, rsaPrivateKey, cryptofix.Hash(0), msg)
	if err != nil {
	...
	if err := VerifyPKCS1v15(&rsaPrivateKey.PublicKey, cryptofix.Hash(0), msg, sig); err != nil {
