...
func (m *clientHelloMsg) updateBinders(pskBinders [][]byte) error {
	...
	if m.raw != nil {
		bts, err := m.marshalWithoutBinders()
		if err != nil {
			return err
		}
		lenWithoutBinders := len(bts)
...
func (m *certificateMsg) marshal() (x []byte, err error) {
	if m.raw != nil {
		return m.raw, nil
	}
...
func (m *certificateRequestMsg) marshal() (x []byte, err error) {
	if m.raw != nil {
		return m.raw, nil
	}
...
func (m *certificateVerifyMsg) marshal() (x []byte, err error) {
	if m.raw != nil {
		return m.raw, nil
	}
...
func (m *newSessionTicketMsg) marshal() (x []byte, err error) {
	if m.raw != nil {
		return m.raw, nil
	}
