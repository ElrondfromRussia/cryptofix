...
import (
	...
	"github.com/ElrondfromRussia/cryptofix/dsa"
	"github.com/ElrondfromRussia/cryptofix/ecdsa"
	"github.com/ElrondfromRussia/cryptofix/ed25519"
	"github.com/ElrondfromRussia/cryptofix/elliptic"
	"github.com/ElrondfromRussia/cryptofix/rsa"
	_ "github.com/ElrondfromRussia/cryptofix/sha1"
	_ "github.com/ElrondfromRussia/cryptofix/sha256"
	_ "github.com/ElrondfromRussia/cryptofix/sha512"
	"github.com/ElrondfromRussia/cryptofix/x509/pkix"
	"io"
	"math/big"
	"net"
	"net/url"
...
var signatureAlgorithmDetails = []struct {
	...
	{MD2WithRSA, "MD2-RSA", oidSignatureMD2WithRSA, RSA, cryptofix.Hash(0) /* no value for MD2 */},
	{MD5WithRSA, "MD5-RSA", oidSignatureMD5WithRSA, RSA, cryptofix.MD5},
	{SHA1WithRSA, "SHA1-RSA", oidSignatureSHA1WithRSA, RSA, cryptofix.SHA1},
	{SHA1WithRSA, "SHA1-RSA", oidISOSignatureSHA1WithRSA, RSA, cryptofix.SHA1},
	{SHA256WithRSA, "SHA256-RSA", oidSignatureSHA256WithRSA, RSA, cryptofix.SHA256},
	{SHA384WithRSA, "SHA384-RSA", oidSignatureSHA384WithRSA, RSA, cryptofix.SHA384},
	{SHA512WithRSA, "SHA512-RSA", oidSignatureSHA512WithRSA, RSA, cryptofix.SHA512},
	{SHA256WithRSAPSS, "SHA256-RSAPSS", oidSignatureRSAPSS, RSA, cryptofix.SHA256},
	{SHA384WithRSAPSS, "SHA384-RSAPSS", oidSignatureRSAPSS, RSA, cryptofix.SHA384},
	{SHA512WithRSAPSS, "SHA512-RSAPSS", oidSignatureRSAPSS, RSA, cryptofix.SHA512},
	{DSAWithSHA1, "DSA-SHA1", oidSignatureDSAWithSHA1, DSA, cryptofix.SHA1},
	{DSAWithSHA256, "DSA-SHA256", oidSignatureDSAWithSHA256, DSA, cryptofix.SHA256},
	{ECDSAWithSHA1, "ECDSA-SHA1", oidSignatureECDSAWithSHA1, ECDSA, cryptofix.SHA1},
	{ECDSAWithSHA256, "ECDSA-SHA256", oidSignatureECDSAWithSHA256, ECDSA, cryptofix.SHA256},
	{ECDSAWithSHA384, "ECDSA-SHA384", oidSignatureECDSAWithSHA384, ECDSA, cryptofix.SHA384},
	{ECDSAWithSHA512, "ECDSA-SHA512", oidSignatureECDSAWithSHA512, ECDSA, cryptofix.SHA512},
	{PureEd25519, "Ed25519", oidSignatureEd25519, Ed25519, cryptofix.Hash(0) /* no pre-hashing */},
}
...
func rsaPSSParameters(hashFunc cryptofix.Hash) (asn1.RawValue, error) {
	var hashOID asn1.ObjectIdentifier

	switch hashFunc {
	case cryptofix.SHA256:
		hashOID = oidSHA256
	case cryptofix.SHA384:
		hashOID = oidSHA384
	case cryptofix.SHA512:
		hashOID = oidSHA512
	}

	hashSize, err := hashFunc.Size()
	if err != nil {
		return asn1.RawValue{FullBytes: nil}, err
	}
...
// CheckSignature verifies that signature is a valid signature over signed from
// a crypto.PublicKey.
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey cryptofix.PublicKey) (err error) {
	var hashType cryptofix.Hash
	...
	case ed25519.PublicKey:
		...
		if ok, err := ed25519.Verify(pub, signed, signature); !ok || err != nil {
...
// signature algorithm.
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo SignatureAlgorithm) (hashFunc cryptofix.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	var pubType PublicKeyAlgorithm

	switch pub := pub.(type) {
	case *rsa.PublicKey:
		pubType = RSA
		hashFunc = cryptofix.SHA256
	...
	case *ecdsa.PublicKey:
		...
		case elliptic.P384():
			hashFunc = cryptofix.SHA384
			sigAlgo.Algorithm = oidSignatureECDSAWithSHA384
		case elliptic.P521():
			hashFunc = cryptofix.SHA512
	...
	for _, details := range signatureAlgorithmDetails {
		if details.algo == requestedSigAlgo {
			...
			if requestedSigAlgo.isRSAPSS() {
				sigAlgo.Parameters, err = rsaPSSParameters(hashFunc)
				if err != nil {
					return
				}
			}
...
func CreateCertificate(rand io.Reader, template, parent *Certificate, pub, priv interface{}) (cert []byte, err error) {
	...
	var signerOpts cryptofix.SignerOpts = hashFunc
